    ...
    return (
        <Fragment>
            <Container id="landing-section">
                <Row>
                    <div>
                        <img src="images/rsz_landing-image.png" className="img-fluid" alt="Landing"/>
                        <div className="landing-inner-text">
                            <div className="d-flex justify-content-center pb-2">why <span className="uncover">Lotus ?</span></div>
                            <div className="d-flex">
                            <i className="fa fa-angle-left pl-1 my-auto" aria-hidden="true"></i>
                            <p className="pl-1 pr-1">odio Fusce sed enim erat. Mauris dictum lorem eu tortor porta placerat. Suspendisse ac vestibulum eros. Nulla mi ipsum, consequat commodo condimentum vitae,</p>
