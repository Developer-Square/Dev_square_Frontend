                    ...
                    <Col xs={12} lg={6}>
                        ...
                        <div className="desc experiences mb-2" onClick={handleChange}>
                            ...
                            <p className="answer hidden">
                                ...
                                In all our projects we've always kept five things consistent, which are our values as a company. They include: <br/>
